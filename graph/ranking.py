...
def main():
    parser = argparse.ArgumentParser(description='リーディングサイヤー賞金の時系列変動を可視化')
    parser.add_argument('--data-dir', default='../report', help='JSONデータが格納されているディレクトリのパス (default: ../report)')
    parser.add_argument('--top-n', type=int, default=10, help='表示する上位種牡馬の数 (default: 10)')
